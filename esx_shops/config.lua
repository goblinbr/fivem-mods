...
Config.Items = {
	...
	{ name = "water", label = "Water", price = 2 },
	{ name = "beer", label = "Beer", price = 25 },
	{ name = 'defib', label = 'Defibrillator', price = 600 },
	{ name = 'cleankit', label = 'Cleaning Kit', price = 5 },
	{ name = 'firstaidkit', label = 'First Aid Kit', price = 100 },
	{ name = 'repairkit', label = 'Car Repair Kit', price = 250 },
	{ name = 'tirekit', label = 'Car Tire Kit', price = 20 },
}
