Locales['en'] = {
  ...
  ['ammo_bought'] = 'purchased %s',
	...
	['no_weapon_for_ammo'] = 'you do not have any weapon with that ammo type!',
  ...
  ['ammo_smg'] = 'smg ammo',
  ['ammo_rifle'] = 'assault rifle ammo',
  ['ammo_mg'] = 'light machine gun ammo',
  ['ammo_sniper'] = 'sniper rifle ammo',
  ['ammo_grenadelauncher'] = 'grenade launcher ammo',
  ['ammo_hominglauncher'] = 'homing launcher ammo',
  ['ammo_minigun'] = 'minigun ammo',
  ['ammo_rpg'] = 'rocket launcher ammo',
